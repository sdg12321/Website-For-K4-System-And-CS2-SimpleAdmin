...
$query = "SELECT name, lastseen, kills, deaths, hits, headshots, grenades, mvp, steam_id, round_win, round_lose FROM k4stats ORDER BY kills DESC LIMIT $recordsPerPage OFFSET $offset";
